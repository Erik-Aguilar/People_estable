    ...
    <small>
      <ul class="nav nav-pills" role="tablist">
        <li role="presentation" class="active">
          <a>Ventas <span class="badge"><?php echo e($datos[0]->ventas); ?></span> </a>
        </li>
        <li role="presentation" class="active">
          <a>Altas <span class="badge"><?php echo e($datos[0]->altas); ?></span> </a>
        </li>

        <li role="presentation" class="active">
          <a>Porcentaje <span class="badge"><?php echo e(($datos[0]->altas * 100) / $datos[0]->ventas); ?></span> </a>
        </li>
