                        ...
                        <div class="panel-body">
							<table class="table table-striped table-bordered table-hover" id="dataTables-example" data-page-length='10'>
                                ...
                                <tbody>
                                        ...
                                        <td><?php echo e(Form::text('dn',$value->dn1,array('class'=>"form-control",'placeholder'=>"", 'readonly'=>''))); ?></td>
                                        ...
                                        <td>
                                            <?php echo e(Form::textarea('observaciones',$value->obs,array('class'=>"form-control", 'rows'=>2, 'cols'=>10, 'placeholder'=>""))); ?>
