    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <?php echo e(Form::open(['action' => 'ReportesController@ReporteIncidencia',
                              'method' => 'post',
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php echo e(Form::text('no_emp',NULL,array('class'=>"form-control", 'placeholder'=>"",'id'=>'no_emp','maxlength'=>'10','required'))); ?>
