            ...
            <div class="row">
              ...
              <div class="login">
                <div class="Absolute-Center is-Responsive">
                  ...
                  <?php echo e(Form::open(['action' => 'DescansosController@Salvar',
                                    'method' => 'post',
                                ...
                                <div class="form-group input-group">
                                  ...
                                  <?php if( $desc == 1  ): ?>
                                    <select class="form-control" name="descanso" <?php echo e(((old("descanso") != '' || $desc) ? "":"disabled")); ?>>
                                      <option value=""></option>
                                      <option value="2" <?php echo e((old("descanso") == 2 ? "selected":"")); ?> >BREAK</option>
                                      <option value="4" <?php echo e((old("descanso") == 4 ? "selected":"")); ?>>CAPACITACIÓN</option>
                                      <option value="5" <?php echo e((old("descanso") == 5 ? "selected":"")); ?>>BAÑO</option>
                                      <option value="6" <?php echo e((old("descanso") == 6 ? "selected":"")); ?>>RETROALIMENTACIÓN</option>
                                      <option value="8" <?php echo e((old("descanso") == 8 ? "selected":"")); ?>>JUNTA</option>
                                    </select>
                                ...
                                <div class="form-group" style="display: none;">
                                  <div class="col-sm-10">
                                    <?php echo e(Form::number('name', $tipo1)); ?>
