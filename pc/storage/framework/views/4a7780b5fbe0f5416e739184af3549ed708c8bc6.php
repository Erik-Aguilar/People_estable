    ...
    <div class="panel panel-default col-md-8 col-md-offset-2">
      <div class="panel-body">
        <?php echo e(Form::open(['action' => 'TmVentasController@TmPreStatusSave',
          ...
          <fieldset>
            <input type="text" style="display: none" class="form-control" name="operador" id="operador" value="<?php echo e(session('user')); ?>">
    ...
    <small>
      <ul class="nav nav-pills" role="tablist">
        <li role="presentation" class="active">
          <a>Ventas <span class="badge" id="num_ventas"> </span> </a>
        </li>
        <li role="presentation" class="active">
          <a>Altas <span class="badge" id="num_altas"> </span> </a>
        </li>

        <li role="presentation" class="active">
          <a>Porcentaje <span class="badge" id="num_porcent"></span> </a>
        </li>
...
$("#validatelrep").click(function(){
  ...
  $.get('repep/buscar/' + $('#telefono').val() + '' ,function(response){
    if (response==0) {
...
<script type="text/javascript">
  ...
  $.ajax({
      ...
      success: function(response) {
        ...
        console.log(response[0].ventas);

        document.getElementById('num_ventas').innerHTML = response[0].ventas;
        document.getElementById('num_altas').innerHTML = response[0].altas;
    }
  });   
