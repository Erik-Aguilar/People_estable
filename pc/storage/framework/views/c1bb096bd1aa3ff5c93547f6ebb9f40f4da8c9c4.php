        ...
        <?php echo e(Form::open(['action' => 'FaceBookVentasController@GuardaVentasChat',
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-7">
                        <?php echo e(Form::select('agente', $agentes, null, [ 'class'=>"form-control", 'placeholder'=>"",'id'=>'sup']  )); ?>
            ...
            <div class="form-group">
              <?php echo e(Form::label('Anuncio','',array('class'=>"col-sm-2 control-label"))); ?>
                ...
                <div class="col-sm-7">
                    <?php echo e(Form::select('anuncio',$anuncios, null,['class'=>"form-control", 'placeholder'=>""])); ?>
