                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('InicioChatFacebook') }}">Inicio</a></li>
                                ...
                                <li><a href="{{ url('/chatFBRevisar') }}"> Revisar Registros</a></li>
                                <li><a href="{{ url('/ingresarAnuncios') }}"> Ingresar Anuncios</a></li>
                                <li><a href="{{ url('/DescargaReporteFacebook') }}"> Reporte Tipificaciones</a></li>
