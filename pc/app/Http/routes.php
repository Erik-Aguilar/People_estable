...
Route::get('/Inbursa_soluciones/ValidacionesDia', [
    'uses' => 'InbursaSolucionesController@InicioValSolucionesDia'
]);
Route::post('/Inbursa_soluciones/ValidacionesDia/lista', [
    'uses' => 'InbursaSolucionesController@VentasValidar'
]);
Route::get('/Inbursa_soluciones/ValidacionesDia/{id}', [
    'uses' => 'InbursaSolucionesController@VentasValidarDatos',
    'middleware' => 'acceso'
]);
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/tm/pre/estadoAgente', [
        'middleware' => 'acceso',
        'uses' => 'EstadoPreController@inicioAgente'
        ]);
    */
    ...
    Route::get('/tm/pre/repep/buscar/{id}', [
        'middleware' => 'acceso',
    ...
    Route::get('tm/pre/ventas/{id}', [
        'uses' => 'EstadoPreController@obtenerVentas'
    ]);
...
Route::get('prepago/supervisor/subirReporteVentas', [
    'uses' => 'SupervisorController@inicioSubirReporteVentas'
]);
Route::post('prepago/supervisor/subirReporteVentas2', [
    'uses' => 'SupervisorController@SubirVentasOperador'
]);
...
Route::get('reportesVentasFB', [
    'uses' => 'FaceBookVentasController@incioReporteVentasFB'
]);
Route::post('reportesVentasFB', [
...
Route::get('DescargaReporteFacebook', [
    'uses'=>'FaceBookVentasController@inicioDescargaReporteFacebook'
]);

Route::post('DescargaReporteFacebook2', [
    'uses'=>'FaceBookVentasController@DescargaReporteFacebook'
]);
...
Route::get('ingresarAnuncios', [
    'uses' => 'FaceBookVentasController@InicioIngresoAnuncios'
]);
Route::post('ingresarAnuncios2', [
    'uses' => 'FaceBookVentasController@ingresarAnuncios'
]);
Route::post('insertarAnuncio', [
    'uses' => 'FaceBookVentasController@InsertaAnuncio'
]);
...
Route::get('/subeCM',[
      'uses'=>'BoController@InicioCM'
    ]);
Route::post('subeCM2',[
  'uses'=>'BoController@subeCM'
]);
