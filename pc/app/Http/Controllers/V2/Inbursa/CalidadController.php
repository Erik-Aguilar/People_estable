  ...
  public function ListaAudiosSoluciones(Request $request)
  {
    ...
    */
    ...
    $info = DB::select(DB::raw("select * 
              from inbursa_soluciones.ventas_soluciones 
              left join pc.calidad_audios on calidad_audios.dn = ventas_soluciones.telefono 
              where estatus_people_2 = 'Venta' and estatusSubido <> '0' and fechaSubido = '$request->fecha' and (calidad_audios.dn is null or calidad_audios.error = 'Si')"));
